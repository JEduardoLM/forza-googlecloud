...
class Subrutina{
    ...
    //***********************************************************************************************************************************
        ...
        function deleteSubrutina($idSubRutina){ // Esta función nos regresa la subrutina de una rutina especifica (dividida por días)
		//Creamos la conexión con la función anterior
		$conexion = obtenerConexion();
    ...
    function getDetalleEjercicioByID ($idEjercicio,$circuitoColor){// Esta función nos regresa el detalle de ejercicios contenidos en una subrutina
     ...
     $RutinaR=$Rutina->getDetalleSubrutina(2);
